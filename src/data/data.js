export const data = [
  {
    ...
    price: 70.00,
    description: 'A mouth-watering double cheeseburger with two juicy beef patties, melted cheese, fresh lettuce, tomato, and a special sauce.'
  },
  {
    id: 2,
    ...
    price: 10.00,
    description: 'Classic cheeseburger topped with crispy bacon, melted cheese, and all the fixings for a satisfying bite.'
  },
  {
    id: 3,
    ...
    price: 30.00,
    description: 'A juicy beef patty topped with sautéed mushrooms and melted Swiss cheese for a rich, earthy flavor.'
  },
  {
    id: 4,
    name: 'Loaded Burger',
    ...
    price: 50.00,
    description: 'Packed with flavor, this burger comes fully loaded with bacon, cheese, onion rings, and BBQ sauce.'
  },
  {
    id: 5,
    name: 'Feta & Spinach',
    ...
    price: 30.00,
    description: 'A delicious vegetarian pizza topped with creamy feta cheese and fresh spinach on a crispy crust.'
  },
  {
    id: 6,
    name: 'Supreme Pizza',
    ...
    price: 40.00,
    description: 'A pizza piled high with pepperoni, sausage, bell peppers, onions, and olives for a flavorful experience.'
  },
  {
    id: 7,
    name: 'Meat Lovers',
    ...
    price: 70.00,
    description: 'The ultimate pizza for meat lovers, loaded with pepperoni, sausage, ham, and bacon.'
  },
  {
    id: 8,
    name: 'Cheese Pizza',
    ...
    price: 10.00,
    description: 'Simple yet satisfying, this pizza features a generous layer of gooey melted cheese on a golden crust.'
  },
  {
    id: 9,
    name: 'Kale Salad',
    ...
    price: 30.00,
    description: 'A healthy and delicious kale salad with fresh ingredients, perfect for a light meal or side dish.'
  },
  {
    id: 10,
    name: 'Caesar Salad',
    ...
    price: 50.00,
    description: 'A classic Caesar salad with crisp romaine lettuce, Parmesan cheese, and creamy Caesar dressing.'
  },
  {
    id: 11,
    name: 'Loaded Salad',
    ...
    price: 70.00,
    description: 'A filling and flavorful salad packed with toppings like chicken, bacon, cheese, and avocado.'
  },
  {
    id: 12,
    name: 'Fruit Salad',
    ...
    price: 10.00,
    description: 'A refreshing fruit salad featuring a mix of seasonal fruits for a light and healthy snack.'
  },
  {
    id: 13,
    name: 'Wings',
    ...
    price: 30.00,
    description: 'Crispy, flavorful chicken wings tossed in your choice of sauce, perfect for sharing or indulging.'
  },
  {
    id: 14,
    name: 'Baked Chicken',
    ...
    price: 70.00,
    description: 'Juicy and tender baked chicken seasoned to perfection, served with a side of vegetables.'
  },
  {
    id: 15,
    ...
    price: 10.00,
    description: 'Crispy chicken tenders served with your choice of dipping sauce, great for a quick and tasty bite.'
  },
  {
    id: 16,
    name: 'Chicken Kabob',
    ...
    price: 50.00,
    description: 'Tender grilled chicken kabobs marinated in spices, served with rice or a side of vegetables.'
  },
];
